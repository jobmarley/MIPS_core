...
################################################################
# This is a generated script based on design: core_test_design
#
...
# source core_test_design_script.tcl
...
set design_name core_test_design
...
proc create_root_design { parentCell } {
  ...
  # Create instance: core_test_0, and set properties
  set block_name core_test
  set block_cell_name core_test_0
  if { [catch {set core_test_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $core_test_0 eq "" } {
